...
import { createAdminUser } from "@/features/admin/api";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">Provision a new IPDC Report Service account.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        {status === "error" && <p className="text-sm font-medium text-red-600">Failed to create user. Please try again.</p>}
