...
const PROFILE_DEFAULTS: ProfileFields = {
  ...
  supervisor: "Zahidul Islam",
  teamLeader: "Farhana Akter",
  phone: "01712345678",
  address: "House 12, Road 5\nGulshan-1, Dhaka 1212\nBangladesh",
  email: "admin@ipdc.com.bd",
};

const BRANCH_OPTIONS = ["Dhaka Main", "Chattogram", "Sylhet", "Khulna", "Rajshahi", "Barishal"];
...
export default function AdminProfilePage(): React.JSX.Element {
  ...
  return (
    <div className="flex flex-col gap-6">
      <Breadcrumb items={[{ label: "Administration", href: "/admin/dashboard" }, { label: "Profile" }]} />
      ...
      <div className="relative rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
        ...
        <div className="flex flex-col divide-y divide-gray-100 lg:flex-row lg:divide-x lg:divide-y-0 lg:pr-40">
          ...
          <div className="flex flex-col gap-4 py-6 lg:flex-1 lg:px-6 lg:py-0">
            <HeroField label="Employee ID" value="IPDC-0001" />
            <HeroField label="Username" value="IPDC-admin" />
            <HeroField label="Role" value="System Administrator" />
          </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white shadow-sm">
          ...
          <div className="flex flex-col gap-4 p-5">
            ...
            <div className="border-t border-gray-50 pt-4">
              ...
              <Link href="/admin/login-history" className="mt-1 inline-block text-sm font-medium text-indigo-600 hover:text-indigo-700">
                2 Active Sessions
              </Link>
            </div>
          </div>
